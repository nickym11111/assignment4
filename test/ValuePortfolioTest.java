...
public class ValuePortfolioTest {
  ...
  IStockDataStream fileReaderMicrosoft = new FileStockDataStreamImpl("stocks/NKE.csv");
  ...
  private IPortfolio nicky;

  @Before
  public void setUp() throws FileNotFoundException {
    this.nicky = new Portfolio("Nicky's Investments");
  ...
  public void testEmptyPortfolio() throws FileNotFoundException {
    IPortfolio portfolio1 = new Portfolio("Technology");
    LocalDate date = LocalDate.of(2014, 5, 1);
